...
library(coda)
library(beepr)
file_route = "...\\Monte Carlo Experiment\\MLBA.cpp" # your own path
df = read_csv(...\\Monte Carlo Experiment\\MLBARCT_data_0801_800.csv")


df_test = read_csv("...\\Monte Carlo Experiment\\MLBARCT_data_0801_800(test).csv")
...
chain_list[[j+1]] = migrate_step(current_chain_list = chain_list[[j+1]])}
  ...
  if(j%%1000==0) {saveRDS(chain_list, file = paste0("estimation results and plots/chain_list_",type0,"_sim","(",npar,")_",N,version,".rds",sep=""))}
  } 
  
return(list(chain_list=chain_list,path = paste0("estimation results and plots/chain_list_",type0,"_sim","(",npar,")_",N,version,".rds",sep="")))
}
########################################
# result generation
result_fun = function(type0, N, attrs,version){
  set.seed(2025)
  path = paste0("estimation results and plots/chain_list_",type0,"_sim","(",npar,")_",N,version,".rds",sep="")
  ...
  write.csv(post,paste("estimation results and plots/Post_sim_",N,"_",type0,"Aug_",version, ".csv",sep=""))
  return(result4)
  write.csv(result4,paste0("estimation results and plots/",type0,"_post_",N,version,".rds",".csv",step = ""))
}
...
if(is.na(mle1$convergence)) {FALSE}
  ...
  if (OK){
    if (type0=="CO"){
      ...
      if(i%%5==0){
        saveRDS(est_mle1_adj_v1,paste("estimation results and plots/",type0,"(",npar,")","_est_sim_MLE",try_times,"Aug_",N,version,".rds",sep=""))
  saveRDS(mle1_list_adj_v1, paste("estimation results and plots/",type0,"(",npar,")","_object_sim_MLE",try_times,"Aug_",N,version,".rds",sep=""))
  saveRDS(mle1_list_sd_v1, paste("estimation results and plots/",type0,"(",npar,")","_sd_sim_MLE",try_times,"Aug_",N,version,".rds",sep=""))
      }}
    else if (i%%3 ==0){
      message(sprintf("%d%% candidates have been found.", round(i/try_times*100)))
    }
    ...
    true_value = c(true_param$beta,
               ...
               LL(para = 
                      c(true_param$beta,
                        ...
                        #true_param$b),
                 type = type0))
  est_mle1_adj_v1 = readRDS(file = paste("estimation results and plots/",type0,"(",npar,")","_est_sim_MLE",try_times,"Aug_",N,version,".rds",sep = ""))
  mle1_list_adj_v1 = readRDS(file = paste("estimation results and plots/",type0,"(",npar,")","_object_sim_MLE",try_times,"Aug_",N,version,".rds",sep = ""))
  mle1_list_sd_v1 = readRDS(file =  paste("estimation results and plots/",type0,"(",npar,")","_sd_sim_MLE",try_times,"Aug_",N,version,".rds",sep = ""))
...
saveRDS(result_table,paste("estimation results and plots/Result_table_bayesian_",version,".rds",sep=""))
...
result_table = readRDS(file = paste("estimation results and plots/Result_table_bayesian_",version,".rds",sep = "") )
mle_res_table = list()
...
saveRDS(mle_res_table,paste("estimation results and plots/Result_table_mle_",version,".rds",sep=""))
```
...
version = "v2"
result_table = readRDS(file = paste("estimation results and plots/Result_table_bayesian_",version,".rds",sep=""))
result_mle_table = readRDS(file = paste("estimation results and plots/Result_table_mle_",version,".rds",sep=""))
...
version = "v3"
saveRDS(acc_table,paste("estimation results and plots/acc_table_",version,".rds",sep=""))
saveRDS(brier_table,paste("estimation results and plots/brier_table_",version,".rds",sep=""))
...
for(sample_size in sample_size_set){
  ...
  post_crt = read_csv(file = paste("estimation results and plots/Post_sim_",N,"_","CRT","Aug_",version,".csv",sep = ""),show_col_types = FALSE)

  post_rtg = read_csv(file = paste("estimation results and plots/Post_sim_",N,"_","RTG","Aug_",version,".csv",sep = ""),show_col_types = FALSE)

  post_co = read_csv(file = paste("estimation results and plots/Post_sim_",N,"_","CO","Aug_",version,".csv",sep = ""),show_col_types = FALSE)
...
saveRDS(post_list,file = paste("estimation results and plots/df_violin_sim_3type_Aug",version,".rds",sep = ""))
...
saveRDS(MLE_df,file = paste("estimation results and plots/df_violin_sim_3type_mle_Aug_",version,".rds",sep=""))
```
...
saveRDS(test,paste("estimation results and plots/Plt_violin_sim_Aug_",version,".rds",sep=""))
```
...
ggsave(paste("estimation results and plots/Full_violin",name[l],"_",version,".pdf",sep=""),
         plot   = plt_tmp ,
...
ggsave(paste("estimation results and plots/Full_violin(",sample_size_set[m],")_",version,".pdf",sep=""),
         plot   = plt_tmp ,
         device = cairo_pdf,  # embeds fonts better; optional
         width  = 8.27, height = 6.5, units = "in")
...
head(MSE_df)
saveRDS(MSE_df,paste("estimation results and plots/df_sim_3type_mse_Aug_",version,".rds",sep=""))
...
# saveRDS(test,file = paste("estimation results and plots/Plt_mse_sim_200_type3_",version,".rds",sep=""))
```
...
```{r}
version = "v2"
violin_plt = readRDS(paste("estimation results and plots/Plt_violin_sim_Aug_",version,".rds",sep=""))
MSE_plt = readRDS(paste("estimation results and plots/Plt_mse_sim_200_type3_",version,".rds",sep=""))
...
# violin_plt[[7]][[l]] = violin_plt[[7]][[l]]+ theme( axis.text.y = element_text(size= 12))
  ...
  # ggsave(paste("estimation results and plots/MSE_violin",name[l],"_",version,".pdf",sep=""),
  #        plot   = plt_temp[[3]] ,
  #        device = cairo_pdf,  # embeds fonts better; optional
  #        width  = 8.27, height = 5.83, units = "in")
  ggsave(paste("estimation results and plots/violin",name[l],"_",version,".pdf",sep=""),
         plot   = plt_temp[[4]] ,
         device = cairo_pdf,  # embeds fonts better; optional
...
saveRDS(acc_df,paste("estimation results and plots/acc_df_",version,".rds",sep=""))
saveRDS(brier_df,paste("estimation results and plots/brier_df_",version,".rds",sep=""))
...
# saveRDS(plt[[2]],file = paste("estimation results and plots/Plt_acc_",version,".rds",sep=""))
...
# saveRDS(plt_b,file = paste("diagnosis results and plots/Diagnosis_plt_beyesian_",version,".rds",sep=""))
...
for(sample_size in sample_size_set){
  for (type0 in type_set){
    ggsave(paste("diagnosis results and plots/Diagnosis_sim_trace_",type0,"_","(",sample_size,")" ,"_",version,".pdf",sep=""),
         plot   = plt_b[[m]]$traceplt[[npar+2]],
         device = cairo_pdf,  # embeds fonts better; optional
         width  = 8.27, height = 5.83, units = "in")

    ggsave(paste("diagnosis results and plots/Diagnosis_sim_sd_",type0,"_","(",sample_size,")" ,"_",version,".pdf",sep=""),
...
```{r}
mle_res_table = readRDS(paste("estimation results and plots/Result_table_mle_",version,".rds",sep=""))
sample_size_set = c(50,80,100,200,400,600,800)
type_set = c("CRT","RTG","CO")
version = "v2"
plt_mle = list()
...
# saveRDS(plt_mle,file = paste("diagnosis results and plots/Diagnosis_plt_mle_",version,".rds",sep=""))
...
for(sample_size in sample_size_set){
  for (type0 in type_set){
    ggsave(paste("diagnosis results and plots/Diagnosis_sim_MLE_",type0,"_","(",sample_size,")" ,"_",version,".pdf",sep=""),
